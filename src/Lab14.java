...
public class Lab14 {
    ...
    public static void countdownDoWhile() { Scanner c = new Scanner (System.in);
        // Implementation here
//        System.out.println("Enter");
//        int x = c.nextint();
//        int i = 0;
...
//        }
    ...
    // 5 x 9 = 45
    // 5 x 10 = 50
//    public static void printMultiplicationTableFor() { Scanner  a = nev Scanner (System.in);
//        // Implementation here
//        System.out.println("Enter");
//        int b = a.nextInt();
//        for (int i = 1; i <= b; i++)System.out.println(b = "x" +i + "=" + (b*i));
//
//    }
